...
<!---<title><?=$data['name']?> - <?=$data['title']?></title>--->
  <title>tAe - The Art Experience</title>
...
<body>
  ...
  <!-- ======= Header <h1><a href="index.php"><?=$data['name']?></a></h1>======= -->
  <header id="header">
    <div class="container">

      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="mr-auto"><img src="assets/img/loo.png" alt="" class="img-fluid"></a> -->
      <h2>A celebration of the role arts plays on the different aspects of the human experience.</h2>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link active" href="#header">Home</a></li>
          <li><a class="nav-link" href="#about">About</a></li>
          <li><a class="nav-link" href="#resume">Events</a></li>
          <li><a class="nav-link" href="#services">Services</a></li>
          <li><a class="nav-link" href="#portfolio">stores</a></li>
...
<br>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Events:</strong> <span><?=$data['degree']?></span></li>
               <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span><a style="color: white;" href="mailto:<?=$data['email']?>"><?=$data['email']?></a></span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Collaborations:</strong> <span>
                  <?php 
                  if($data['freelance'] == 1){
                    echo "Available";
                  }
      ...
      <div class="col-lg-4 col-md-6 portfolio-item all">
                  <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-info">
                      <h4>Fashion</h4>
                      <p>This is more info about heading</p>
                      <div class="portfolio-links">
                        <a href="/assets/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="title"><i class="bx bx-plus"></i></a>
                        <a href="index.php" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <section id="resume" class="resume">
    <div class="container">
      ...
      <div class="section-title">
        <h2>The Gate Event</h2>
        <p>THE ART EXPERIENCE</p>
      </div>
  ...
  <div class="credits">
    ...
    Designed by <a href="<?=$details_data['url']?>" target="_blank">Siya Percy</a>
  </div>
