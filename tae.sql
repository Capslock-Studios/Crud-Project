...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2023 at 11:15 AM
...
(2, 'Siyabonga Percy Ndaba', 'myself@siyapercy.online', 'asd', 'asd'),
(3, 'Siya Percy', 'siyapercy@kamover.co.za', 'ss', 'sss');
...
(2, 'bi bi-emoji-smile', 500, 11, 'Mentees'),
(3, 'bi bi-emoji-smile', 0, 6, 'Assistents'),
(4, 'bi bi-emoji-smile', 0, 4, 'Ventures');
...
(1, 'Kamover', '1', 'vvp', '2022-06-15', '#', 'lksbdvasdv', 'assets/img/portfolio/portfolio-1.jpg'),
...
(1, 'Ingenuity', 'ri-store-line', 'ffbb2c'),
(2, 'Leadership', 'ri-bar-chart-box-line', '4CEB95'),
(3, 'Artistry', 'ri-bar-chart-box-line', 'E75C54'),
(4, 'software Development', 'ri-bar-chart-box-line', 'ffbb2c');
...
(1, 'Siya Percy', 'Makhazasi', 'hello@theartexperience.co.za', '81dc9bdb52d04dc20036dbd8313ed055', 'Innovations Company', 'Gauteng', '#', '#', '#', '#', '#', '', 'From a young age I\'ve always been interested in peculiar topics like the origin of the human race and other existential questions so it\'s a no no surprise that I ended up precuring studies in the sciences and a BSC from UCT was a no brainer as from that I can teach a computer to teach me how to learn faster and persue what I really want...a Phd in Physics, philosophy and bio-chemistry. \r\n\r\nMy educational journey starts with qualifications from Graphic Design, Animation and currently Computer Science.', '2023-06-19', 'www.theartexperience.co.za', '0783695417', 'Johannesburg', '31', 'Jozi Fashion Fest', 1, 'CEH, CHFI', '123, Johannesburg, Gauteng');
